...
To obtain $b$ we use 
\begin{equation}
b = \dot{\vec e}_{v-u} \cdot  {\vec e}_r = - {\vec e}_{v-u} \cdot  \dot {\vec e}_r =  - {\vec e}_{v-u} \cdot  {\vec v} / r = - v / r,    
\end{equation}
...
\begin{equation}
    \vec e_{v-u}(t+h) = \vec e_{v-u}(t) + a h \vec e_p(t) - \frac{v h}{r} \vec e_r(t)
\end{equation}
